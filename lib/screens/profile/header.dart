  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text('Nafis Rayan', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
        const SizedBox(height: 8),
        const Text('nafis.rayan@example.com', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
